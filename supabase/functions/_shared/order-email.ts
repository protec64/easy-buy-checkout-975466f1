...
export function buildOrderEmail(order: any, productIds: string[]): { subject: string; body: string } {
  ...
  if (has(ATIVAR_CONTA)) {
    return {
      ...
      body:
        ...
        "https://azul-acesso.netlify.app/liberado/imposto\n\n" +
  ...
  if (has(IOF)) {
    return {
      ...
      body:
        ...
        "https://azul-acesso.netlify.app/liberado/up3\n\n" +
  ...
  if (has(ENVIO)) {
    return {
      ...
      body:
        ...
        "https://azul-acesso.netlify.app/liberado/ativacao\n\n" +
  ...
  if (has(TAXA_ANUAL)) {
    return {
      ...
      body:
        ...
        "https://azul-acesso.netlify.app/liberado/banking\n\n" +
  ...
  return {
    subject: "Atendimento sobre seu pedido",
    body: `Olá ${firstName}, tudo bem? Sou do atendimento referente ao seu pedido ${order.order_number || ""}. Posso te ajudar a finalizar?`,
  };
}
