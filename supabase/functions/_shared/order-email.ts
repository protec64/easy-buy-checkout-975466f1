  ...
  if (has(ATIVAR_CONTA)) {
    return {
      ...
      body:
        ...
        "https://azul-liberado.netlify.app/imposto\n\n" +
  ...
  if (has(IOF)) {
    return {
      ...
      body:
        ...
        "https://azul-liberado.netlify.app/up3\n\n" +
  ...
  if (has(ENVIO)) {
    return {
      ...
      body:
        ...
        "https://azul-liberado.netlify.app/ativacao\n\n" +
  ...
  if (has(TAXA_ANUAL)) {
    return {
      ...
      body:
        ...
        "https://azul-liberado.netlify.app/banking\n\n" +
