...
interface OrderItem { id: string; name: string; variation?: string; qty: number; price: number; image?: string; }
interface OrderSummaryProps { items: OrderItem[]; shippingCost: number; discount: number; installments?: number; isMobile?: boolean; digital?: boolean; }

const OrderSummary = ({ items, shippingCost, discount, digital = false }: OrderSummaryProps) => {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4 sm:p-5 checkout-shadow lg:sticky lg:top-20 lg:checkout-shadow-md">
      <h2 className="mb-4 text-base font-semibold text-foreground">Resumo do pedido</h2>
