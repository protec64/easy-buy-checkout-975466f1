...
import taxasCard from "@/assets/taxas-card.jpg.asset.json";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/taxa1" element={<Checkout key="taxa1" productId="804a87c3-c43e-4173-b71c-069d83911bc8" digital overrideImage={taxasCard.url} />} />
          <Route path="/taxa2" element={<Checkout key="taxa2" productId="31ccbc66-dff2-4273-a3f1-d6e7858a2578" digital overrideImage={taxasCard.url} />} />
          <Route path="/taxa3" element={<Checkout key="taxa3" productId="4e1e0583-f0c9-47e9-8632-2e5c81a43518" digital overrideImage={taxasCard.url} />} />
          <Route path="/taxa4" element={<Checkout key="taxa4" productId="bf888b49-0d72-4aeb-a202-d391c5432f95" digital overrideImage={taxasCard.url} />} />
